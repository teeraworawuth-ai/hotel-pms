                  ...
                  {locRooms.map(room => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative aspect-[16/15] w-full flex items-center justify-center rounded-xl border-2 transition-all active:scale-95 group overflow-hidden isolate ${statusClass}`}
                      >
